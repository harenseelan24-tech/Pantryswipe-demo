  ...
  return (
    <View style={styles.container}>
      ...
      <View style={StyleSheet.absoluteFill}>
        {(() => {
          try {
            return <Image source={require("@/assets/images/hero-food.png")} style={styles.bgImage} resizeMode="cover" />;
          } catch {
      ...
      <Animated.View style={[styles.content, { opacity: fadeAnim, transform: [{ translateY: slideAnim }], paddingTop: topPadding + 40, paddingBottom: bottomPadding + 24 }]}>
        ...
        <View style={styles.ctaContainer}>
          <TouchableOpacity style={[styles.primaryButton, { backgroundColor: colors.saffron }]} onPress={() => router.push("/onboarding")} activeOpacity={0.88}>
            <Text style={styles.primaryButtonText}>Get Started</Text>
          </TouchableOpacity>

          <TouchableOpacity style={styles.secondaryButton} onPress={() => router.replace("/(tabs)")} activeOpacity={0.88}>
...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 40, fontWeight: "800", color: "#FFFFFF", letterSpacing: -1.5, textAlign: "center" },
  tagline: { fontSize: 18, color: "rgba(255,255,255,0.80)", fontWeight: "400", textAlign: "center", lineHeight: 26 },
  ctaContainer: { gap: 12 },
  primaryButton: { height: 56, borderRadius: 100, alignItems: "center", justifyContent: "center" },
